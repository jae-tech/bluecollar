          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-lg leading-relaxed text-muted-foreground text-pretty max-w-lg">
                흩어져 있던 시공 기록을 60초 만에 세련된 디지털 프로필 사이트로 만드세요.
                명함 대신 링크 하나면 충분합니다.
              </p>
            </div>
            ...
            <div className="flex items-center gap-6 pt-2">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-semibold text-foreground">2,400+</span> 명의 현장 전문가가 이미 사용 중
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-lg">
              ...
              <div className="bg-card rounded-2xl border border-border shadow-2xl overflow-hidden">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute -bottom-1 -right-1 bg-primary rounded-full p-0.5">
                        <CheckCircle2 size={14} className="text-primary-foreground fill-primary-foreground" />
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="font-bold text-lg text-foreground">김철수</h3>
                        <span className="text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full font-medium">인증됨</span>
                      </div>
                      <p className="text-sm text-muted-foreground mt-0.5">서울 · 경기 전문 시공팀</p>
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {["목공", "타일", "전기"].map((tag) => (
                          <span key={tag} className="text-xs bg-secondary text-foreground px-2.5 py-1 rounded-full border border-border font-medium">
                            {tag}
                          </span>
                        ))}
                      </div>
                    ...
                    <div className="text-right flex-shrink-0">
                      ...
                      <p className="text-xs text-muted-foreground mt-0.5">리뷰 138개</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Project grid */}
                <div className="p-4">
                  <p className="text-xs font-semibold text-muted-foreground mb-3 uppercase tracking-wide">최근 시공 프로젝트</p>
              ...
              <div className="absolute -top-4 -right-4 bg-card border border-border rounded-2xl px-4 py-3 shadow-lg">
                <p className="text-xs text-muted-foreground font-medium">이번 달 완료</p>
                <p className="text-2xl font-bold text-foreground mt-0.5">12건</p>
                <p className="text-xs text-primary font-semibold mt-0.5">+3 지난달 대비</p>
              </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-card border border-border rounded-2xl px-4 py-3 shadow-lg flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                    <path d="M8 1a7 7 0 100 14A7 7 0 008 1zm0 2a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm0 10a5.5 5.5 0 01-4.33-2.1C4.68 9.9 6.26 9 8 9s3.32.9 4.33 1.9A5.5 5.5 0 018 13z" fill="#FF6B00"/>
                  </svg>
                </div>
                <div>
