  ...
  return (
    ...
    >
      <div className="aspect-video overflow-hidden bg-secondary relative">
        ...
        />
        <span className="absolute top-2 left-2 text-xs bg-foreground/70 text-primary-foreground px-2 py-0.5 rounded font-medium">
          {project.category}
        </span>
      </div>
      <div className="p-3.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="ml-auto text-xs text-muted-foreground border border-border px-2 py-0.5 rounded">
